...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-04-2020 a las 17:51:18
...
INSERT INTO `distrito` (`id`, `nombre`, `provincia_id`, `departamento_id`) VALUES
...
INSERT INTO `provincia` (`id`, `nombre`, `departamento_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO `rol` (`id`, `name`, `estado`) VALUES
(1, 'admin', 'A'),
(2, 'user', 'A');
...
INSERT INTO `usuario` (`id`, `rol_id`, `nombre`, `apellidos`, `direccion`, `telefono`, `email`, `password`, `skin_url`, `estado`) VALUES
(1, 1, 'gjusto', 'gjusto 21', 'calle 1', '975644855', 'admin@admin.com', '$2a$10$4lAQrKbf2c.8nLedVBAtqu8oqYpXK1zzuWVe6L6QAWzW.vBMEhlai', 'www.coas.xom', 'A');
...
ALTER TABLE `compra`
  ...
  ADD KEY `compra___fk2` (`proveedor_id`);
...
ALTER TABLE `compra_producto`
  ...
  ADD KEY `compra_producto___fk2` (`producto_id`);
...
ALTER TABLE `direccion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK` (`distrito_id`,`pais_id`),
  ADD KEY `direccion___fk1` (`pais_id`);
...
ALTER TABLE `distrito`
  ADD PRIMARY KEY (`id`),
  ADD KEY `distrito__fk1` (`departamento_id`),
  ADD KEY `distrito_ibfk_2` (`provincia_id`);
...
ALTER TABLE `notas`
  ...
  ADD KEY `notas___fk2` (`usuario_id`);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `pedido___fk2` (`cliente_id`);
...
ALTER TABLE `pedido_producto`
  ...
  ADD KEY `pedido_producto___fk2` (`producto_id`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `producto___fk2` (`almacen_id`),
  ADD KEY `producto___fk3` (`atributo_valor_id`),
  ADD KEY `producto___fk4` (`marca_id`),
  ADD KEY `producto___fk5` (`unidad_id`);
...
ALTER TABLE `provincia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `provincia___fk1` (`departamento_id`);
...
--
ALTER TABLE `almacen`
  ADD CONSTRAINT `almacen___fk1` FOREIGN KEY (`direccion_id`) REFERENCES `direccion` (`id`);

--
-- Filtros para la tabla `atributo_valor`
--
ALTER TABLE `atributo_valor`
  ADD CONSTRAINT `atributo_valor___fk1` FOREIGN KEY (`atributo_id`) REFERENCES `atributo` (`id`);

--
-- Filtros para la tabla `compra`
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra___fk1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `compra___fk2` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedor` (`id`);

--
-- Filtros para la tabla `compra_producto`
--
ALTER TABLE `compra_producto`
  ADD CONSTRAINT `compra_producto___fk1` FOREIGN KEY (`compra_id`) REFERENCES `compra` (`id`),
  ADD CONSTRAINT `compra_producto___fk2` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`);

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `direccion___fk1` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`id`),
  ADD CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`distrito_id`) REFERENCES `distrito` (`id`);

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `distrito__fk1` FOREIGN KEY (`departamento_id`) REFERENCES `departamento` (`id`),
  ADD CONSTRAINT `distrito_ibfk_2` FOREIGN KEY (`provincia_id`) REFERENCES `provincia` (`id`);

--
-- Filtros para la tabla `image`
--
ALTER TABLE `image`
  ADD CONSTRAINT `image___fk1` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`);

--
-- Filtros para la tabla `notas`
--
ALTER TABLE `notas`
  ADD CONSTRAINT `notas___fk1` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`),
  ADD CONSTRAINT `notas___fk2` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`);

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido___fk1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `pedido___fk2` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`);

--
-- Filtros para la tabla `pedido_producto`
--
ALTER TABLE `pedido_producto`
  ADD CONSTRAINT `pedido_producto___fk1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido` (`id`),
  ADD CONSTRAINT `pedido_producto___fk2` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`);

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `producto___fk1` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`),
  ADD CONSTRAINT `producto___fk2` FOREIGN KEY (`almacen_id`) REFERENCES `almacen` (`id`),
  ADD CONSTRAINT `producto___fk3` FOREIGN KEY (`atributo_valor_id`) REFERENCES `atributo_valor` (`id`),
  ADD CONSTRAINT `producto___fk4` FOREIGN KEY (`marca_id`) REFERENCES `marca` (`id`),
  ADD CONSTRAINT `producto___fk5` FOREIGN KEY (`unidad_id`) REFERENCES `unidad` (`id`);

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `proveedor___fk1` FOREIGN KEY (`direccion_id`) REFERENCES `direccion` (`id`);

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `provincia___fk1` FOREIGN KEY (`departamento_id`) REFERENCES `departamento` (`id`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario___fk1` FOREIGN KEY (`rol_id`) REFERENCES `rol` (`id`);
COMMIT;
